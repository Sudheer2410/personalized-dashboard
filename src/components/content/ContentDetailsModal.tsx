        ...
        >
          ...
          >
            ...
            <div className={`relative overflow-hidden flex-shrink-0 ${
              isMovie ? 'h-64 md:h-72' : 'h-48 md:h-56'
            }`}>
              {/* Loading Skeleton */}
              {imageLoading && (
              ...
              {item.type === 'recommendation' && (
                <div className="absolute top-4 left-32 z-10">
                  <div className="flex items-center space-x-1 px-3 py-1 bg-yellow-500 text-white rounded-full">
            ...
            <div className="flex-1 overflow-y-auto p-6">
              ...
              {isSocial && (item.likes || item.retweets || item.comments) && (
                <div className="mb-4 flex items-center space-x-6 text-sm text-gray-600 dark:text-gray-400">
                  {item.likes && (
                    <div className="flex items-center space-x-1">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                >
                  {isMovie ? 'View on TMDB' : isSocial ? 'View Original Post' : 'Read Full Article'}
                </button>
                <button
                  onClick={handleFavoriteToggle}
